...
A continuação mostra-se linhas a executar desde a console de *R*, esses comandos instalarám alguns dos pacotes e librerias de linux que são úteis na meteorologia. 
